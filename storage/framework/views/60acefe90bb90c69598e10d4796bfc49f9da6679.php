...
<div id="layoutSidenav_content">
    ...
    <script>
        ...
        var debit = <?php echo json_encode($debit_this_mounth, 15, 512) ?>/1;
        var kredit = <?php echo json_encode($kredit_this_mounth, 15, 512) ?>/1;
        ...
        type: 'bar',
        data: {
            labels: <?php echo json_encode($top_five_produk, 15, 512) ?>,
            datasets: [{
            label: "Keuntungan",
            lineTension: 0.3,
            ...
            pointHitRadius: 50,
            pointBorderWidth: 2,
            data: <?php echo json_encode($top_five_harga, 15, 512) ?>,
            }],
        },
        options: {
            scales: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\rodirodi\ppl-agro-a1\resources\views/owner/ownerRekapitulasiDetail.blade.php ENDPATH**/ ?>