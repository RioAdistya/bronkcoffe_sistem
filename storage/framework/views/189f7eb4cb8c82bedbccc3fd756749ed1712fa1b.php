                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/karyawanProduksi/edit/<?php echo e($k->id); ?>" class="btn btn-warning my-2 mx-1">Edit</a>
                                <a href="/karyawanProduksi/detail/<?php echo e($k->id); ?>" class="btn btn-success">Detail</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\rodirodi\ppl-agro-a1\resources\views/owner/karyawanproduksi.blade.php ENDPATH**/ ?>