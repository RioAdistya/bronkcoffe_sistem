    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            <div class="container-fluid px-4 py-4">
                ...
                <hr>
                <div class="form-edit">
                    <form method="post" action="/karyawanProduksi/update/<?php echo e($karyawan->id); ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 col-md-9 col-xl-10">
                                <select name="status" class="form-control" placeholder="Status Karyawan" value="<?php echo e($karyawan->status); ?>">
                                    <option selected><?php echo e($karyawan->status); ?></option>
                                    <?php if($karyawan->status == 'Tidak Aktif'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\rodirodi\ppl-agro-a1\resources\views/owner/karyawanProduksiEdit.blade.php ENDPATH**/ ?>