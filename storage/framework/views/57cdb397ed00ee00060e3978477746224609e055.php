    ...
    <div class="container-fluid px-4">
        <div class="card mt-3 mb-3">
            ...
            <div class="card-header text-start">
                <i class="bi bi-table"></i> <strong>Riwayat Penggunaan <?php echo e($bahan->namaBahan); ?></strong> 
            </div>
            <?php break; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\rodirodi\ppl-agro-a1\resources\views/owner/ownerBahanBakuDetail.blade.php ENDPATH**/ ?>