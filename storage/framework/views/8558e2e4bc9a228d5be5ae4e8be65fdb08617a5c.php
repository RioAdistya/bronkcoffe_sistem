                    ...
                    <table class="table table-light table-striped justify-content-center text-center" style="font-size: 20px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a href="/stockKopi/edit/<?php echo e($p->namaProduk); ?>/<?php echo e($p->kategori); ?>" class="btn btn-warning my-2">Edit Stok</a>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\rodirodi\ppl-agro-a1\resources\views/produksi/produksiStockKopiDetail.blade.php ENDPATH**/ ?>